...
<section class="bloc_page2 container-fluid">
	...
	<div class="row">
	    ...
	    <div class="admin col-xs-12 col-sm-12 col-md-8  col-lg-9 col-xl-10">
    		...
    		<p class="alert alert-danger" role="alert"> Etes-vous sûr(e) de vouloir supprimer le commentaire de <b><?php echo htmlspecialchars($comment['author']); ?></b> du chapitre <b>"<?php echo htmlspecialchars($comment['title']); ?>"</b> ?       
            </p>

            <!-- oui = lien vers save delete -->

            <div class="btn-group" role="group">
	            <form action="index.php?action=saveCommentDelete&amp;id=<?= $comment['id'] ?>" method="post" class="" name="saveDelete">
	            ...
	            <!-- non = lien vers page d'avant -->
		  		...
		  		<div>
		  			<a href="index.php?action=tableComments" class="btn btn-outline-primary btn-post" role="button">
